...
function sendWishlistToWhatsApp() {
    const wishlistItems = document.querySelectorAll('#wishlistItems li');
    const totalGems = document.getElementById('totalGems').textContent;
    ...
    const phoneNumber = "918759403171"; // your WhatsApp number
