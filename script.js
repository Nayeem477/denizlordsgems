function openTab(tabName) {
    ...
    event?.target?.classList.add('active'); // Safely handle event if available
...
// Initialize with MonsterHunt tab active and populate all tabs on load
document.addEventListener('DOMContentLoaded', () => {
    // Pre-populate all tabs to ensure content is ready
    ['MonsterHunt', 'SpeedUps', 'Combat', 'PlayerExp', 'Resources', 'ChestsTools', 'OtherItems', 'MergingAnima'].forEach(tab => {
        openTab(tab); // Call openTab for each tab to populate
    });
    // Set MonsterHunt as active initially
    openTab('MonsterHunt');
});